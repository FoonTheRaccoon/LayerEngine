...
namespace VkNames
{
	...
	// Returns string for LOG_VKRESULT to use
	inline const char* GetVkResultName(VkResult vkResult)
	{
		switch (vkResult)
		{
		case VK_SUCCESS:
		...
		default:
			return "!VK result Name Not found, this shouldn't be possible!";
		}
	} // GetVkResultName

	// Returns string for VkPhysicalDeviceFeatures struct member
	inline const char* GetVkPhysicalDeviceFeaturesName(u32 index)
	{
	...
	// Returns string for VkPresentModeKHR enum
	inline const char* GetVkPresentModeKHRName(VkPresentModeKHR mode)
	{
		switch (mode)
		{
			...
			default:
				return "!VkPresentModeKHR Name Not found, this shouldn't be possible!";
		}
	}

	// Returns string for VkFormat enum
	inline const char* GetVkFormatName(VkFormat format)
	{
		switch (format)
		{
			...
			default:
				return "!VkFormat Name Not found, this shouldn't be possible!";
		}
	} // GetVkFormatName

	// Returns string for VkColorSpaceKHR enum
	inline const char* GetVkColorSpaceKHRName(VkColorSpaceKHR colorSpace)
	{
		switch (colorSpace)
		{
			...
			default:
				return "!VkColorSpaceKHR Name Not found, this shouldn't be possible!";
		}
	} // GetVkColorSpaceKHRName
