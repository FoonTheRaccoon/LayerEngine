// Only include std headers, no third party
#include <cstdint>
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifdef __ANDROID__
#define LAYER_PLATFORM_ANDROID 1
#else
#define LAYER_PLATFORM_ANDROID 0
#endif

#ifdef _WIN64
#define LAYER_PLATFORM_WINDOWS 1
#else
#define LAYER_PLATFORM_WINDOWS 0
#endif

#if defined(__linux__) && !defined(__ANDROID__)
#define LAYER_PLATFORM_LINUX 1
#else
#define LAYER_PLATFORM_LINUX 0
#endif

#ifdef __APPLE__
#define LAYER_PLATFORM_APPLE 1
#else
#define LAYER_PLATFORM_APPLE 0
#endif
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// PLATFORM ALIASES (Forward declare if needed)
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
